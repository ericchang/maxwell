...
public class ColumnDefTest {
	private ColumnDef build(String type, boolean signed) {
		return ColumnDef.build("foo", "bar", "", type, null, null, 1, signed, null);
	}
	...
	public void testUTF8String() {
		ColumnDef d = ColumnDef.build("foo", "bar", "utf8", "varchar", null, null, 1, false, null);
	...
	public void TestUTF8MB4String() {
		...
		ColumnDef d = ColumnDef.build("foo", "bar", "utf8mb4", "varchar", null, null, 1, false, null);
	...
	public void TestAsciiString() {
		...
		ColumnDef d = ColumnDef.build("foo", "bar", "ascii", "varchar", null, null, 1, false, null);
	...
	public void TestStringAsJSON() {
		...
		ColumnDef d = ColumnDef.build("foo", "bar", "latin1", "varchar", null, null, 1, false, null);
